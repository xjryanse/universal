 ...
 * 班线
 */
class UniversalItemCircuitBusService extends Base implements MainModelInterface {
...
// 静态模型：配置式数据表
    ...
    protected static $mainModelClass = '\\xjryanse\\universal\\model\\UniversalItemCircuitBus';
